            ...
            <div id="content">
                <div class="movie_menu">
                    <router-link tag="div" to="/movie/city" class="city_name">
                        <span>{{ $store.state.city.nm }}</span><i class="iconfont icon-jiantou-xia-cuxiantiao"></i>
                    </router-link>
        ...
        setTimeout(()=>{
            this.axios.get('/api/getLocation').then((res)=>{
                ...
                if(msg === 'ok'){
                    ...
                    if(this.$store.state.city.id == id){return;}  //已在当前城市无需再弹出切换弹窗
                    messageBox({
                        title: '定位',
                        content: nm,
                        cancel: '取消',
...
<style scoped>
#content .movie_menu{ width: 100%; height: 45dpx; border-bottom: 1px solid #e6e6e6; display: flex; justify-content: space-between;}
